...
enum e_ctrlID{
    CTRL_ID_LBL_FIRSTNAME = 1,
    CTRL_ID_LBL_LASTNAME,
    CTRL_ID_LBL_PSEUDO,
    CTRL_ID_LBL_MAIL,
    CTRL_ID_LBL_PHONENUMBER,

    CTRL_ID_LED_FIRSTNAME,
    CTRL_ID_LED_LASTNAME,
    CTRL_ID_LED_PSEUDO,
    CTRL_ID_LED_MAIL,
    CTRL_ID_LED_PHONENUMBER,

    CTRL_ID_GAU_PARAMETER1,
    CTRL_ID_GAU_PARAMETER2,
    CTRL_ID_GAU_PARAMETER3,
    CTRL_ID_GAU_PARAMETER4,
    CTRL_ID_GAU_PARAMETER5,
